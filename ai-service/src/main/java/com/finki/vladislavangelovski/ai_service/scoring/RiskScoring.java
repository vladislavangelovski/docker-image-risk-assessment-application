...
public final class RiskScoring {
  ...
  public static double perCveScore(
      double epss,
      double cvssBase,
      double coverageNorm,
      double wEpss,
  ...
  public static int overallImageScore(
      List<TopFinding> top, Map<String, Double> epssByCve, double wEpss, double wCvss) {
  ...
  public static double coverageNormFromInstances(int affectedInstances, int cap) {
