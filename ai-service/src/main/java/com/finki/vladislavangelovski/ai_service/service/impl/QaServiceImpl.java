...
public class QaServiceImpl implements QaService {
    ...
    public QaQuestionResponse ask(QaQuestionRequest request) {
        List<Citation> citations = List.of(
                new Citation("CVE-2021-44228",
                        "https://nvd.nist.gov/vuln/detail/CVE-2021-44228",
                        "Log4j RCE (Log4Shell)")
        );
        return new QaQuestionResponse(
                "Stub answer: This image appears affected by Log4Shell. Upgrade Log4j and rebuild.",
                citations,
    ...
    public QaClaimResponse judge(QaClaimRequest request) {
        ...
        return new QaClaimResponse(
                ...
                "Stub verdict: insufficient evidence to confirm or deny the claim.",
                citations
        );
    }
}
